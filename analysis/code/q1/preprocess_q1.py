...
if ubuntu_deer:
    ...
    #
    # Preparing Node
    dt_node = pd.read_csv(filelist[1])
    ...
    # Chromium63
    dt_chromium63 = pd.read_csv(filelist[3])
    ...
    # Firefox57
    dt_firefox57 = pd.read_csv(filelist[7])
